...
// The use of innerHTML creates a potential security risk(cross-site scripting) for your website. Not recommendedk
...
const watchList = [
 ...
 for (let i = 0; i < watchList.length; i++) {
   ratings3.push({title: watchList[i]["Title"], rating: watchList[i]["imdbRating"]});
 }
